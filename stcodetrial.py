...
with st.sidebar:
    ...
    if st.session_state.data_file != chosen_file:
        ...
        prompt_template = f"""
        You are am expert Python programmer with particular knowledge of the Streamlit framework. The following text enclosed in angle brackets, <>, is a text file describing Streamlit features that you may know know about. Use this text file as you primary source of information about Steamlit.
